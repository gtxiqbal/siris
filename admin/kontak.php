		...
		<main>
			<div class="row container"> <br><br>
					...
					<div class="col s12 m12 offset-l2 l12 ">
						<center><h4>Kontak</h4></center>
				        <div class="card-panel lighten-5 z-depth-1">
				          <div class="row valign-wrapper">
				            <div class="col s2">
				              <img src="../images/1.jpg" alt="Gue Siapa?" class="circle responsive-img"> 
				            </div>
				            <div class="col s12">
				            ...
				            <div class="col s2">
				              <img src="../images/3.png" alt="Siapa Gue?" class="circle responsive-img"> 
				            </div>
				            <div class="col s12">
				              <span class="black-text">
				                Siapa Gue?
